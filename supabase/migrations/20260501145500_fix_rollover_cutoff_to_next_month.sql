...
comment on function public.confirm_season_rollover(uuid)
  is 'Closes the current editable season (draft or active). Rollover opens at 06:00 Asia/Shanghai on the first day of the next season month; season managers may finalize immediately, while scorekeepers still require two confirmations.';
